  ...
  return (
    <section className='flex flex-col gap-6'>
      ...
      <p className='prose dark:prose-invert'>
        늙어서도 유쾌하게 일하고 싶은 개발자입니다. 현재 팀스파르타라는 회사에서 좋은 동료들에 파묻혀 정말 재밌게 일하고
        있어요.
        <br />
        <br />
        돈과 명성만 바라보고 반도체 설비 엔지니어로 직장 생활을 시작했었어요. 돈은 만족스러웠어요! 근데 웃음이
        가득한 제 모습을 잃어버렸었습니다. 그래서 &apos;더 늦기 전에 저를 되찾고 정말 재밌어서 할 수 있는 일을 해보자&apos;라는
        ...
        단기적인 계획과 목표를 생각할 수 있더라구요. 아마 주말 오전 10 ~ 11시 사이에 사당에서 관악산 등산을 시작하시면 저를 목격하실
        수도 있어요.
        <br />
        ...
        으로 책을 고르고 있어요. 그리고 인상 깊었던 책들은 독후감으로 남기고 있어요.
      </p>
    </section>
  );
}
